...
export class InterviewEngine {
  ...
  getStats(): { total: number; active: number; completed: number; totalAnswers: number } {
  ...
  private getSummary(): Array<{ id: string; title: string; completed: boolean; progress: number; questionCount: number }> {
