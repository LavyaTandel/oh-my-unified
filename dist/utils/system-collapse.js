 ...
 */
export function collapseSystemInPlace(messages, maxLength = 4000) {
    ...
    if (systemMsg.content.length <= maxLength)
        return;
    // Collapse: keep first 500 chars + last 500 chars
    const collapsed = systemMsg.content.slice(0, 500) +
...
//# sourceMappingURL=system-collapse.js.map