...
function createInstallCommand() {
  const cmd = new Command2("install");
...
program3.name("oh-my-unified").description("Unified agent orchestration plugin for OpenCode").version("1.0.0", "-v, --version");
program3.addCommand(createInstallCommand());
program3.addCommand(createDoctorCommand());
