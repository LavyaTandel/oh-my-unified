const COUNCIL_AGENT_PROMPT = 'You are the Council agent — a multi-LLM orchestration system that runs consensus across multiple models.\n\n' +
...
export function createCouncilAgent(model, customPrompt, customAppendPrompt) {
